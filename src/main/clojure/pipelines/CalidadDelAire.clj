           ...
           ;Nombre de la 
             (graph (graph-base "calidad-aire-en-euskadi-2017") 
                ...
                [observation-C8hAQ
                 ...
                 [observation-value-predicate (languageVasque (str (removeSymbols (row "CO-8h-Air-Quality"))))]
                 [observation-value-predicate (languageSpanish (str (removeSymbols varCO8AQ-CAST)))]
                   ]
                   [observation-NO
                 [rdf:a uriNOgen]
                 ...
                 [observation-value-predicate (languageVasque (str (removeSymbols (row "NO2-Air-Quality"))))]
                 [observation-value-predicate (languageSpanish (str (removeSymbols varNO2AQ-CAST)))]
                   ]
                    [observation-NOX
                 [rdf:a uriNOXgen]
                ...
                [unit-measure-predicate micragram-cmeter-predicate]
                 ...
                 [observation-value-predicate (languageVasque (str (removeSymbols (row "PM10-Air-Quality"))))]
                 [observation-value-predicate (languageSpanish (str (removeSymbols varPM10AQ-CAST )))]
                   ] 
                   [observation-PM25
                 [rdf:a uriPM25gen]
                 ...
                 [observation-value-predicate (languageVasque (str (removeSymbols (row "PM25-Air-Quality"))))]
                 [observation-value-predicate (languageSpanish (str (removeSymbols varPM25AQ-CAST )))]
                   ] 
                   [observation-ICAAQ
                 [rdf:a uriICAEstaciongen]
                 [rdfs:comment ICAAQ-coment]
                 [observation-value-predicate (languageVasque (str (removeSymbols (row "ICA-estacion"))))]
                 [observation-value-predicate (languageSpanish (str (removeSymbols varICAE-CAST)))]
                   ] 
                    [observation-Benceno
                 [rdf:a uriBencenogen]
