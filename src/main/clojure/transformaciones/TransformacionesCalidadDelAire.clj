...
(def CO8hAQ-coment (languageSpanish (str "Es la clasificación de Índice de Calidad del Aire de la CAPV correspondiente al contaminante  de CO y  al periodo temporal de 1 día")))
...
(def NO2AQ-coment (languageSpanish (str "Es la clasificación de Índice de Calidad del Aire de la CAPV correspondiente al contaminante NO2 y  al periodo temporal de 1 día")))
...
(def PM10AQ-coment (languageSpanish (str "Es la clasificación de Índice de Calidad del Aire de la CAPV correspondiente al contaminante  PM10 y  al periodo temporal de 1 día")))
(def PM25-coment (languageSpanish (str "Es el promedio diario de concentración PM2.5")))
(def PM25AQ-coment (languageSpanish (str "Es la clasificación de Índice de Calidad del Aire de la CAPV correspondiente al contaminante  PM2.5 y  al periodo temporal de 1 día")))
