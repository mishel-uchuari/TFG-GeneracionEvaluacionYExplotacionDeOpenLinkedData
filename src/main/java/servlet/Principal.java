...
public class Principal {
	public static void main(String[] args) throws IOException, RDFHandlerException {
		RT.loadResourceScript("pipelines/RelacionesPuestoTrabajo.clj");
		 LazySeq lazy = (LazySeq) RT.var("pipelines.RelacionesPuestoTrabajo",
		 "convertidor").invoke("./DatosIniciales/otro.csv");
