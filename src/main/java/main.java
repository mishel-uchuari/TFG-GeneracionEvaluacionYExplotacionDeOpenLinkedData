...
public class main {
	public static void main(String[] args) throws IOException, RDFHandlerException, RepositoryException,
		...
		Pipeline pipeRetribNominativas = new Pipeline("RetribucionesNominativas", "convertidor",
		...
		/**
		 * GraphDB nd = new GraphDB(); String st =
		 * nd.executeGraphQuery("construct{ ?s ?p ?o} where { ?s ?p ?o } limit
		 * 10");
		 */
