           ...
           ;Nombre de la 
            (graph (base-graph) 
                ...
                [uriEstacion
                 ...
                 [base-medicion uriNO2AirQualitygen]
                 [base-medicion uriNOXgen]
                 [base-medicion uriPM10gen]
                 [base-medicion uriPM10AirQualitygen]
                 [base-medicion uriPM25gen]
                 [base-medicion uriPM25AirQualitygen]
                 [base-medicion uriICAEstaciongen]
                 [base-medicion uriOrtoxilenogen]
                 [base-medicion uriEtilbencenogen]
                 [base-medicion uriToluenogen]
                 [base-medicion uriBencenogen]
                 ]          
                [observation-CO
                 [rdf:a uriCOgen]
